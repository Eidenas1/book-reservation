...
const LoginModal = ({ isOpen, onClose, onSwitchRegister, onLoginSuccess }) => {
  ...
  return (
    ...
    >
      <div
        className=" bg-black relative w-2/4 h-5/6 flex flex-col items-center max-xl:w-1/2 max-md:w-full max-md:h-full max-lg:w-3/4 shadow-[inset_0_0_5000em_rgba(255,255,255,1)]"
